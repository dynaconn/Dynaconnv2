function varargout = DFC_NewPlot(varargin)
% DFC_NewPlot MATLAB code for DFC_NewPlot.fig
%      DFC_NewPlot, by itself, creates a new DFC_NewPlot or raises the existing
%      singleton*.
%
%      H = DFC_NewPlot returns the handle to a new DFC_NewPlot or the handle to
%      the existing singleton*.
%
%      DFC_NewPlot('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DFC_NewPlot.M with the given input arguments.
%
%      DFC_NewPlot('Property','Value',...) creates a new DFC_NewPlot or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DFC_NewPlot_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DFC_NewPlot_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DFC_NewPlot
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @DFC_NewPlot_OpeningFcn, ...
                   'gui_OutputFcn',  @DFC_NewPlot_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DFC_NewPlot is made visible.
function DFC_NewPlot_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DFC_NewPlot (see VARARGIN)

% Choose default command line output for DFC_NewPlot
...
% UIWAIT makes DFC_NewPlot wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DFC_NewPlot_OutputFcn(hObject, eventdata, handles) 
